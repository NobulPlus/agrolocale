...
import styles from './plantain.module.css'

export const metadata: Metadata = {
  title: 'Plantain – Fresh Farm Plantain | Agrolocale',
  description:
    'Farm-fresh plantain harvested at the right stage and handled with care from farm to bag. Consistent quality, no shortcuts. ₦24,590 / 25 kg — nationwide delivery.',
}
...
const accountabilityPoints = [
  {
    ...
    desc: 'Every bunch is cut at just the right stage of ripeness, so it arrives ready to cook, fry, or ripen further exactly as you need it.',
  },
  {
    icon: '🧊',
    title: 'Careful Post-Harvest Handling',
    desc: 'From the farm to dispatch, our plantain is handled to avoid bruising and pressure damage — never stacked or thrown in ways that shorten its shelf life.',
  },
  {
    icon: '🔍',
    title: 'Sorted & Graded by Hand',
    desc: 'Each bag is hand-sorted to remove damaged, overripe, or underdeveloped fingers before it ever reaches you — no shortcuts, no bulk dumping.',
  },
]
          ...
          <div className={styles.heroInner}>
            <div className={styles.heroText}>
              ...
              <h1 className={styles.heroTitle}>
                Plantain —{' '}
                <em className={styles.heroAccent}>Farm-Fresh, Perfectly Timed</em>{' '}
                For Your Kitchen
              </h1>
              <p className={styles.heroSub}>
                Plantain handled with the same care from harvest to delivery, so it reaches you at
                the right stage of ripeness. No shortcuts, no guesswork — just consistent quality,
                batch after batch.
              </p>
              <div className={styles.heroCtas}>
                <a href="#buy" className={styles.ctaBuy}>Buy Plantain Today</a>
            ...
            <div className={styles.heroImgWrap}>
              ...
              <Image
                src="/farm-produce/plantain.png"
                alt="Plantain – Fresh Farm Plantain 25 kg"
                fill
          ...
          <div className={styles.trustGrid}>
            <div className={styles.trustLeft}>
              ...
              <h2 className={styles.sectionTitle}>
                Buying Plantain Online Feels Like a Gamble. We Know That.
              </h2>
            </div>
            <div className={styles.trustRight}>
              <p className={styles.trustPara}>
                ...
                of us have ordered &ldquo;fresh&rdquo; plantain and received something bruised, overripe,
                or nothing like what the photo promised.
              </p>
              <p className={styles.trustPara}>
                A nice product photo doesn&apos;t tell you how the plantain was cut, how it traveled,
        ...
        <div className="container">
          <div className={styles.questionCard}>
            ...
            <h2 className={styles.questionText}>
              So, why should <span className={styles.questionAccent}>Plantain</span> be any different?
            </h2>
            <p className={styles.questionAnswer}>
              Fair question. We&apos;re not asking you to just trust the label — we&apos;d rather show
              you exactly how our plantain is grown, handled, and delivered, so you can judge for
              yourself.
            </p>
          </div>
        </div>
        ...
        <div className="container">
          <div className={styles.originGrid}>
            <div className={styles.originImgWrap}>
              <Image
                src="/farm-produce/plantain.png"
                alt="Plantain 25 kg farm-fresh bag"
                fill
            ...
            <div className={styles.originContent}>
              ...
              <h2 className={styles.sectionTitle}>
                Plantain Wasn&apos;t Built to Be Just Another Bag of Produce
              </h2>
              <p className={styles.originPara}>
                Too much plantain sold in bulk gets cut too early or too late to survive transport,
                then sits too long before reaching a buyer — by then the texture and flavor have
                already suffered. We built our plantain line around fixing exactly that: cut at the
              ...
              <div className={styles.originCallout}>
                ...
                <p className={styles.originCalloutText}>
                  What Plantain truly sells is <strong>freshness you can actually taste</strong>.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className={styles.sectionCenter}>
            ...
            <p className={styles.accountSub}>
              None of this shows on the outside of the bag — but it&apos;s all there in the plantain
        ...
        <div className="container">
          <div className={styles.closeGrid}>
            <div className={styles.closeLeft}>
              ...
              <p className={styles.closePara}>
                Our plantain line is still building its name, and we&apos;re not going to pretend
          ...
          <div className={styles.buyContent}>
            ...
            <div className={styles.buyBtns}>
              ...
              <Link href={`https://wa.me/2348081977992?text=${encodeURIComponent(
                  `Hello, I am interested in buying plantain.`
