...
export const metadata: Metadata = {
  title: 'Tomato – Fresh & Juicy Farm Tomatoes | Agrolocale',
  description:
    'Farm-fresh tomatoes picked ripe and handled with care from harvest to delivery. Consistent quality, no shortcuts. ₦24,590 / 25 kg — nationwide delivery.',
}
...
const accountabilityPoints = [
  {
    ...
    desc: 'Every batch is harvested right at its peak — full color, firm flesh, and natural sweetness in every crate.',
  },
  {
    icon: '🧊',
    title: 'Cold-Chain Handling',
    desc: 'From the farm to dispatch, our tomatoes move through controlled cold storage that slows spoilage and keeps them firm — never left to sit and soften in the sun.',
  },
  {
    icon: '🔍',
    title: 'Sorted & Graded by Hand',
    desc: 'Each bag is hand-sorted to remove bruised, overripe, or damaged tomatoes before it ever reaches you — no shortcuts, no bulk dumping.',
  },
]
          ...
          <div className={styles.heroInner}>
            <div className={styles.heroText}>
              ...
              <h1 className={styles.heroTitle}>
                Tomato —{' '}
                <em className={styles.heroAccent}>Fresh & Juicy</em>{' '}
                From Farm to Table
              </h1>
              <p className={styles.heroSub}>
                Ripe, juicy tomatoes handled with the same care from harvest to delivery. No
                shortcuts, no guesswork — just consistent quality, batch after batch.
              </p>
              <div className={styles.heroCtas}>
                <a href="#buy" className={styles.ctaBuy}>Buy Tomato Today</a>
            ...
            <div className={styles.heroImgWrap}>
              ...
              <Image
                src="/farm-produce/tomato.jpeg"
                alt="Tomato – Fresh & Juicy Farm Tomatoes 25 kg"
                fill
          ...
          <div className={styles.trustGrid}>
            <div className={styles.trustLeft}>
              ...
              <h2 className={styles.sectionTitle}>
                Buying Tomatoes Online Feels Like a Gamble. We Know That.
              </h2>
            </div>
            <div className={styles.trustRight}>
              <p className={styles.trustPara}>
                ...
                of us have ordered &ldquo;fresh&rdquo; tomatoes and received something bruised, overripe,
                or nothing like what the photo promised.
              </p>
              <p className={styles.trustPara}>
                A nice product photo doesn&apos;t tell you how the tomatoes were picked, how they
        ...
        <div className="container">
          <div className={styles.questionCard}>
            ...
            <h2 className={styles.questionText}>
              So, why should <span className={styles.questionAccent}>Tomato</span> be any different?
            </h2>
            <p className={styles.questionAnswer}>
              Fair question. We&apos;re not asking you to just trust the label — we&apos;d rather show
              you exactly how our tomatoes are grown, handled, and delivered, so you can judge for
              yourself.
            </p>
          </div>
        </div>
        ...
        <div className="container">
          <div className={styles.originGrid}>
            <div className={styles.originImgWrap}>
              <Image
                src="/farm-produce/tomatoXpepper.jpg"
                alt="Tomato 25 kg farm-fresh bag"
                fill
            ...
            <div className={styles.originContent}>
              ...
              <h2 className={styles.sectionTitle}>
                Tomato Wasn&apos;t Built to Be Just Another Bag of Produce
              </h2>
              <p className={styles.originPara}>
                Too many tomatoes sold in bulk get picked early to survive transport, then sit too
                long before reaching a buyer — by then the flavor and firmness have already faded.
                We built our tomato line around fixing exactly that: pick at the right time, handle
                it properly, move it fast.
              </p>
              <div className={styles.originCallout}>
                <span className={styles.originCalloutIcon}>🍅</span>
                <p className={styles.originCalloutText}>
                  What Tomato truly sells is <strong>freshness you can actually taste</strong>.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className={styles.sectionCenter}>
            ...
            <p className={styles.accountSub}>
              None of this shows on the outside of the bag — but it&apos;s all there in the tomatoes
        ...
        <div className="container">
          <div className={styles.closeGrid}>
            <div className={styles.closeLeft}>
              ...
              <p className={styles.closePara}>
                Our tomato line is still building its name, and we&apos;re not going to pretend
          ...
          <div className={styles.buyContent}>
            ...
            <div className={styles.buyBtns}>
              ...
              <Link href={`https://wa.me/2348081977992?text=${encodeURIComponent(
                `Hello, I am interested in buying tomato.`
